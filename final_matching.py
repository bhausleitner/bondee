...
with open("./employee_profiles.pkl",'rb') as fp:
    df = pickle.load(fp)
...
print("*** bondee matching DONE ***")

print("bondee matched most similar employees to employee #", random_user, '\n')

top_10_sim = corr_group[[random_user]].sort_values(by=[random_user],axis=0, ascending=False)[1:11]

print(top_10_sim)

print("\nThe most similar employees to employee #", random_user, "is employee #", top_10_sim.index[0])